...
if __name__ == "__main__":
    ...
    vehicle_type = 'Car-Type-Mini'  # sys.argv[1]
    fuel_type = 'Diesel'  # sys.argv[2]
...
double get_emissions_by_vehicle_type() {
    ...
    string command = "python3 emissions_by_vehicle_type.py " + vehicle_type + " " + fuel_type + " " + distance + " " + unit;
